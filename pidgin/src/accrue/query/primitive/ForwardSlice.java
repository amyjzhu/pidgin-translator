...
/**
 * Select a graph that contains the edges up to a particular depth forward from
 * a selected set of nodes
 */
public class ForwardSlice extends PrimitiveExpression {
     ...
     *            Depth to slice to
     */
    public ForwardSlice(Expression e, Argument<?> d) {
        this.e = e;
        this.depth = d;
    }
...
//    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof ForwardSlice)) {
            return false;
        }
        ForwardSlice other = (ForwardSlice) obj;
    ...
    public String toString() {
        return "forwardSlice(" + e + (depth.isAbsent() ? "" : ", " + depth.value()) + ")";
    }
}
